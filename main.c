...
GOptionEntry entries[] = {
        ...
        {"nogui", 'g', 0, G_OPTION_ARG_NONE, &nogui, "run without gui, in daemon mode", 0},
        {0}
};
...
static void write_results(const char *pattern, int maxcount) {
...
int daemon_loop(void)
{
        ...
        char buffer[1024];
        ssize_t r;
        setup_filenames_core(NULL, NULL);
